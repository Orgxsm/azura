...
{id:'arche',name:"L'Île de l'Arche",center:[32,36],r:14,spawn:[20.5,26],dock:{x:19.8,y:.6,z:24.4,heading:Math.atan2(-.7,-1.6),len:2.5,width:1.6,build:false},landing:[20.5,26]}
];
