...
const game={name:'',shells:new Set(),notes:new Set(),quests:{shells:0,cat:0,crabs:0,bread:0,treasure:0,fish:0,notes:0,goats:0,oil:0,farm:0,hens:0,market:0,bouquet:0,laine:0},goatsCaught:0,oil:false,coins:25,seeds:{tomate:3},produce:{},plots:{},harvested:0,seedSel:0,unlocked:[],farmLevel:0,shorn:{},log:[],discovered:{},playtime:0,clock:DAY*.1,catFollow:false,crabsCaught:0,fish:0,delivered:{},dug:false,fireworksUntil:-1,finale:false,island:'azura'};
let playing=false,dialog=null,dirty=false,lastSave=0,minigame=null;
const NAMES={tomas:'Tomas',anae:'Anaé',lila:'Lila',oro:'Oro',pia:'Pia',marco:'Marco',bastien:'Bastien',cat:'Pistache',gardien:'Elio',marchand:'Basile'};
...
const places=[{id:'village',name:'Le village',x:-2.5,z:3,r:3.5,minY:3},{id:'port',name:'La crique',x:-4.2,z:14.5,r:2.4,minY:0},{id:'summit',name:'Le belvédère',x:1.7,z:-5,r:2.5,minY:9.4},{id:'phare',name:"La crique du Phare",x:35.5,z:-8,r:4,minY:.3},{id:'champs',name:"L'Île des Champs",x:-32,z:10,r:5,minY:1}];
