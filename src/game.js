...
return wrap({lines:[n.said?"Alors, qu'est-ce qu'on fait aujourd'hui ?":"Bienvenue à l'étal ! J'achète tes récoltes et tes œufs, et je vends les mêmes graines qu'Anaé, sans traverser la mer."],end:()=>openShop('market')});
